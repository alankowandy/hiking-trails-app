        ...
        Column(
            ...
            HorizontalPager(
                ...
                when (selectedTabIndex) {
                    ...
                    1 -> {
                        mainViewModel.getTrailsByDifficulty("Łatwy")
                        val trailList = mainViewModel.trailList.collectAsState(initial = listOf()).value
                        if (!trailList.isNullOrEmpty()) {
                            TrailList(
                                trails = trailList,
                    ...
                    2 -> {
                        mainViewModel.getTrailsByDifficulty("Średni")
                        val trailList = mainViewModel.trailList.collectAsState(initial = listOf()).value
                        if (!trailList.isNullOrEmpty()) {
                            TrailList(
                                trails = trailList,
                    ...
                    3 -> {
                        mainViewModel.getTrailsByDifficulty("Trudny")
                        val trailList = mainViewModel.trailList.collectAsState(initial = listOf()).value
                        if (!trailList.isNullOrEmpty()) {
                            TrailList(
                                trails = trailList,
